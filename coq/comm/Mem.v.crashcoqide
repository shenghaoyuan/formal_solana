...
Definition mem := ZMap.t (option u8).

Definition init_mem : mem := ZMap.init None.
...
Definition loadv (mc : memory_chunk) (m : mem) (addr : addr_type) : option val :=
  option_val_of_u64 mc
    (match mc with
     | M8  => option_u64_of_u8_1 (ZMap.get (Int64.unsigned addr) m)
     | M16 => option_u64_of_u8_2 (ZMap.get (Int64.unsigned addr) m) (ZMap.get (Int64.unsigned (Int64.add addr (Int64.repr 1))) m)
     | M32 => option_u64_of_u8_4 (ZMap.get (Int64.unsigned addr) m)
                                   (ZMap.get (Int64.unsigned (Int64.add addr (Int64.repr 1))) m)
                                   (ZMap.get (Int64.unsigned (Int64.add addr (Int64.repr 2))) m)
                                   (ZMap.get (Int64.unsigned (Int64.add addr (Int64.repr 3))) m)
     | M64 => option_u64_of_u8_8 (ZMap.get (Int64.unsigned addr) m)
                                   (ZMap.get (Int64.unsigned (Int64.add addr (Int64.repr 1))) m)
                                   (ZMap.get (Int64.unsigned (Int64.add addr (Int64.repr 2))) m)
                                   (ZMap.get (Int64.unsigned (Int64.add addr (Int64.repr 3))) m)
                                   (ZMap.get (Int64.unsigned (Int64.add addr (Int64.repr 4))) m)
                                   (ZMap.get (Int64.unsigned (Int64.add addr (Int64.repr 5))) m)
                                   (ZMap.get (Int64.unsigned (Int64.add addr (Int64.repr 6))) m)
                                   (ZMap.get (Int64.unsigned (Int64.add addr (Int64.repr 7))) m)
     end).
...
Definition storev (mc : memory_chunk) (m : mem) (addr : addr_type) (v : val) : option mem :=
  ...
  | M8  =>
      match v with
      | Vbyte v' =>
          Some (ZMap.set (Int64.unsigned addr) (Some v') m)
      | _        => None
      end
  | M16 =>
      match v with
      | Vshort v' =>
          ...
          let mem' := ZMap.set (Int64.unsigned addr) (Some (List.nth 0 l Byte.zero)) m in
          Some (ZMap.set (Int64.unsigned (Int64.add addr (Int64.repr 1))) (Some (List.nth 1 l Byte.zero)) m)
      | _        => None
      end
  | M32 =>
      match v with
      | Vint v' =>
          ...
          let mem' := ZMap.set (Int64.unsigned addr) (Some (List.nth 0 l Byte.zero)) m in
          let mem' := ZMap.set (Int64.unsigned (Int64.add addr (Int64.repr 1))) (Some (List.nth 1 l Byte.zero)) m in
          let mem' := ZMap.set (Int64.unsigned (Int64.add addr (Int64.repr 2))) (Some (List.nth 2 l Byte.zero)) m in
          Some (ZMap.set (Int64.unsigned (Int64.add addr (Int64.repr 3)))  (Some (List.nth 3 l Byte.zero)) m)
      | _        => None
      end
  | M64 =>
      match v with
      | Vlong v' =>
          ...
          let mem' := ZMap.set (Int64.unsigned (Int64.add addr (Int64.repr 1))) (Some (List.nth 1 l Byte.zero)) m in
          let mem' := ZMap.set (Int64.unsigned (Int64.add addr (Int64.repr 2))) (Some (List.nth 2 l Byte.zero)) m in
          let mem' := ZMap.set (Int64.unsigned (Int64.add addr (Int64.repr 3))) (Some (List.nth 3 l Byte.zero)) m in
          let mem' := ZMap.set (Int64.unsigned (Int64.add addr (Int64.repr 4))) (Some (List.nth 4 l Byte.zero)) m in
          let mem' := ZMap.set (Int64.unsigned (Int64.add addr (Int64.repr 5))) (Some (List.nth 5 l Byte.zero)) m in
          let mem' := ZMap.set (Int64.unsigned (Int64.add addr (Int64.repr 6))) (Some (List.nth 6 l Byte.zero)) m in
          Some (ZMap.set (Int64.unsigned (Int64.add addr (Int64.repr 7))) (Some (List.nth 7 l Byte.zero)) m)
      | _        => None
      end   
  end.
