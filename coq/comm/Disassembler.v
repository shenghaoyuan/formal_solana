...
From bpf Require Import rBPFCommType rBPFSyntax rBPFDecoder.


Import ListNotations.
Notation "x /\ y" := (andb x y).

Definition disassemble_lddw (i1 i2 : u64) : option bpf_instruction :=
  ...
  let imm1 : i32 := Int.repr (Int64.signed (decode_bpf i1 32 32)) in
  ...
  let imm2 : i32 := Int.repr (Int64.signed (decode_bpf i2 32 32)) in
...
Definition disassemble_one_instruction (data : u64) : option bpf_instruction :=
...
Fixpoint disassemble (l : list u64) : option ebpf_asm :=
  match l with
  | nil => Some nil
  | h :: t => 
