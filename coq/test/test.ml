...
(*
  ...
  {
    dis = "test_ldxw";
    lp_std = [97L; 16L; 4L; 0L; 0L; 0L; 0L; 0L; 149L; 0L; 0L; 0L; 0L; 0L; 0L; 0L];
    lm_std = [0xaaL; 0xbbL; 0x11L; 0x22L; 0x33L; 0x44L; 0xccL; 0xddL];
    lc_std = [];
    isok = true;
    v = 2L;
    fuel = 2L;
    result_expected = 0xddcc4433L;   
  };
  (*
    mov r0, r1
    sth [r0], 0x1234
  ...
  {
    dis = "test_ldxdw";
    lp_std = [121L; 16L; 0L; 0L; 0L; 0L; 0L; 0L; 149L; 0L; 0L; 0L; 0L; 0L; 0L; 0L];
    lm_std = [0xaaL; 0xbbL; 0x11L; 0x22L; 0x33L; 0x44L; 0x55L; 0x66L; 0x77L; 0x88L; 0xccL; 0xddL];
    lc_std = [];
    isok = true;
    v = 2L;
    fuel = 2L;
    result_expected = 0x665544332211bbaaL;   
  };
  (*
    mov r0, r1
    ldxb r9, [r0+0]
...
*)
  {
    dis = "test_stw";
    lp_std = [0x62L; 0x01L; 0x04L; 0x00L; 0x11L; 0x22L; 0x33L; 0x44L; 0x61L; 0x10L; 0x04L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x95L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L];
...
(*
    stdw [r1+8], 0x44332211
    ldxdw r0, [r1+8]
    exit
*)
{
  dis = "test_stdw";
  lp_std = [0x7aL; 0x01L; 0x08L; 0x00L; 0x11L; 0x22L; 0x33L; 0x44L; 0x79L; 0x10L; 0x08L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x95L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L];
...
*)
  {
    dis = "test_stxw";
    lp_std = [0xb4L; 0x02L; 0x00L; 0x00L; 0x11L; 0x22L; 0x33L; 0x44L; 0x63L; 0x21L; 0x08L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x61L; 0x10L; 0x08L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x95L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L];
    lm_std = [0xaaL; 0xbbL; 0xffL; 0xffL; 0xffL; 0xffL; 0xccL; 0xddL];
    lc_std = [];
    isok = true;
    v = 2L;
...
*)
  {
    dis = "test_stxdw";
    lp_std = [0xb7L; 0x02L; 0x00L; 0x00L; 0x55L; 0x66L; 0x77L; 0x88L; 0x67L; 0x02L; 0x00L; 0x00L; 0x20L; 0x00L; 0x00L; 0x00L; 0x47L; 0x02L; 0x00L; 0x00L; 0x11L; 0x22L; 0x33L; 0x44L; 0x7bL; 0x21L; 0x08L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x79L; 0x10L; 0x08L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x95L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L];
    lm_std = [0xaaL; 0xbbL; 0xffL; 0xffL; 0xffL; 0xffL; 0xffL; 0xffL; 0xffL; 0xccL; 0xddL];
    lc_std = [];
    isok = true;
    v = 2L;
...
*)
  {
    dis = "test_subnet";
    lp_std = [0xb7L; 0x02L; 0x00L; 0x00L; 0x0eL; 0x00L; 0x00L; 0x00L; 0x69L; 0x13L; 0x0cL; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x55L; 0x03L; 0x02L; 0x00L; 0x81L; 0x00L; 0x00L; 0x00L; 0xb7L; 0x02L; 0x00L; 0x00L; 0x12L; 0x00L; 0x00L; 0x00L; 0x69L; 0x13L; 0x10L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x57L; 0x03L; 0x00L; 0x00L; 0xffL; 0xffL; 0x00L; 0x00L; 0x55L; 0x03L; 0x05L; 0x00L; 0x08L; 0x00L; 0x00L; 0x00L; 0x0fL; 0x21L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0xb7L; 0x00L; 0x00L; 0x00L; 0x01L; 0x00L; 0x00L; 0x00L; 0x61L; 0x11L; 0x02L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x57L; 0x01L; 0x00L; 0x00L; 0xffL; 0xffL; 0xffL; 0x00L; 0x15L; 0x01L; 0x01L; 0x00L; 0x00L; 0x3cL; 0x46L; 0x00L; 0xb7L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x95L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L; 0x00L];
