        ...
        let assembly_code = match length {
            ...
            InstructionLength::TwoOperands => {
                match class {
                    ...
                    {
                        let dwi1: i64 = rng.gen_range((i64::MIN / 8) as i64..=(i64::MAX / 8) as i64);
                        let dwi = dwi1 * 8;
...
fn main() -> std::io::Result<()> {
    ...
    let num_test_cases = args.get(1).map_or(100000, |x| x.parse::<usize>().unwrap_or(100));
