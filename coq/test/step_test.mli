...
module Mem :
 sig
  ...
  val alloc : mem -> int64 -> int64 -> mem' * block
...
val intlist_to_reg_map : Int.int list -> reg_map

val int_to_bpf_ireg : Int.int -> bpf_ireg

val step_test :
  Int.int list -> Int.int list -> Int.int list -> Int.int list -> Int.int ->
