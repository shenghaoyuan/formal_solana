...
Definition eval_pqr64_2
  ...
  if is_v1 then
    ...
    let dv_u : int128 := Int128.repr (Int64.unsigned (eval_reg dst rm)) in
    let sv_u : int128 := Int128.repr (Int64.unsigned (eval_snd_op_u64 sop rm)) in
    let dv_i : int128 := Int128.repr (Int64.signed (eval_reg dst rm)) in
    let sv_i : int128 := Int128.repr (Int64.signed (eval_snd_op_i64 sop rm)) in
    match pop2 with
