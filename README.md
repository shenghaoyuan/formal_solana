...
| Validation Framework (Section 5) | coq: glue code1 `coq/model/Interpreter.v#L822` + glue code2 `coq/model/Interpreter.v#L848` + extraction declration `test/exec_semantics/coq_test/extract.v#L48`, OCaml: glue code `test/exec_semantics/coq_test/glue.ml`, interpreter_test `test/exec_semantics/coq_test/interpreter_test.ml`, step_test `test/exec_semantics/coq_test/step_test.ml`| 
